  ...
  ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Liste des stockde produit</h1>
       ...
       <div>
        ...
        if (isset($_GET['modif'])&&$_GET['modif']=="ok"){
            print'<div class="alert alert-success">quantite modifier avec success</div>';
        }
        ?>
  ...
  <tbody>
    ...
    $i=0;
      ...
      $i++;
        ...
        <td>'.$s['quantite'].'</td>
        <td>
          <a  class="btn btn-success" data-toggle="modal" data-target="#editModal'.$s['id'].'">modifier</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modifier quantite</h5>
      ...
      <form action="modifier.php" method="POST">
        <div class="form-group">
           <input type="hidden" name="idstock" value="<?php echo $s['id'];?> ">
            <input type="number" class="form-control" name="quantite" id="" value="<?php echo $s['quantite'];?>"placeholder="quantite..">
